...
git clone https://github.com/YosysHQ/picorv32.git ./picorv32-repo

# Copy the main Verilog file to our RTL directory
cp ./picorv32-repo/picorv32.v ./picorv32/rtl/

# Copy some useful files for reference
cp -r ./picorv32-repo/firmware ./picorv32/
cp -r ./picorv32-repo/picosoc ./picorv32/
